...
| Checkpoint label removed                                                          | The PR rejoins the segment above and mirrors it again — and so does every PR that was below it, which no longer has an authority of its own. A reconcile re-derives the whole segment, not just the PR that changed.                                                                  |
